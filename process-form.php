...
try {
    // Ustawienia serwera
    $mail->SMTPDebug = SMTP::DEBUG_OFF;                      // Wyłącz szczegółowe informacje debugowania (ustaw DEBUG_SERVER dla debugowania)
    ...
    $mail->Password   = 'Tmobile1';                            // Hasło SMTP (zmień na swoje)
